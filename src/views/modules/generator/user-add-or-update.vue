<template>
  <el-dialog
    ...
    <el-form-item label="学号" prop="eduNum">
    ...
    <el-form-item label="性别" prop="sex">
      <el-radio-group  v-model="dataForm.sex">
        <el-radio v-for="(sex, i) in sysdict['sex_type']" class="radio" :label="i" :key="i">{{sex}}</el-radio>
      </el-radio-group>
    </el-form-item>
    <el-form-item label="用户昵称" prop="nickName">
      <el-input v-model="dataForm.nickName" placeholder="用户昵称"></el-input>
    </el-form-item>
    <el-form-item label="学校" prop="uniacadaId">
      <el-popover
          ref="menuListPopover"
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          userType: [
            { required: true, message: '2为老师不能为空', trigger: 'blur' }
          ],
          sex: [
          ...
          uniacadaId: [
            { required: true, message: '学校系ID不能为空', trigger: 'blur' }
          ],
          avatar: [
